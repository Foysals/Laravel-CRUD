...
<div class="container-fluid">
    ...
    <div class="content">
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    <a href="{{route('adduser')}}" class="btn btn-success rounded-5 pull-right pt-2">Add User</a>
                    <div class="card-box">
                    ...
                    @endif
                       ...
                       @foreach ($userinfo as $info)                         
                                    <tr>
                                        ...
                                        <td> 
                                            <a href="{{route('edit',$info->id)}}" class="btn btn-primary"><i class="fas fa-edit"></i></a>
                                            <a href="{{route('delete',$info->id)}}" onclick="deleteuser({{$info->id}})" class="btn btn-danger"><i class="fa fa-trash" aria-hidden="true"></i></a>
                                        </td>
                                    </tr>
                           @endforeach
                            </tbody>
